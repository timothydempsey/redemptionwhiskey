...
if( isset( $_GET['username'] ) AND $_GET['username'] != '' ):
	...
	require_once('../../include/twitter/oauth/twitteroauth.php'); //Path to twitteroauth library

	$username = $_GET['username'];
	$limit = ( isset( $_GET['count'] ) AND $_GET['count'] != '' ) ? $_GET['count'] : 2;
	$consumerkey = "bMPYxmOT9ybnyzbyhsK9D4ghX";
	$consumersecret = "GrVqVlf5yslzcqa9CpbS91IDYM8nUiizhQYAE5QnPYUJa2RWba";
	$accesstoken = "874713325858422784-zn8mwWLOIyf3lgN6B2xP1tKfzplJMm3";
	$accesstokensecret = "19IJhNWxHCltu54x7jY0YVDbFE2oZcLAZOWB8lh8LMhUN";
